...
console.log(userId) //특정1 : 할당전 - undefined (초기화 없이 선언 가능)
...
// 2. let
let userName;
console.log(userName) //특징 1. 할당 전 - undefined (초기화 없이 선언 가능)
//let userName = '홍길동'; // 특징 2. 재선언 - 불가능 (동일 스코프에 중복 선언 불가능)

userName = '홍길동';
userName = '고길동'; // 특징 3. 재할당 - 가능
...
// const userHobby; - Error
const userHobby = '요리';
// const userHobby = '등산' // 특징 2. 재선언 - 불가능

// userHobby = '등산'; - Error // 특징 3. 재할당 - 불가능
