...
const greeting = function (name) { 
  console.log(`${name} greeting avenue`)
  return `${name} greeting avenue`
}
...
parameterTest('hello')
parameterTest(10);
parameterTest('a','b','c') // 더 많은 인자 전달시 초과되는 값은 무시됨
...
// restTest();
restTest('a','b','c'); // 0번 인덱스, 1번 인덱스, 2번 인덱스
