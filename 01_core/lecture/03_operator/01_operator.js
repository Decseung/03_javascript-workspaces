...
// 동등비교 연산자는 피 연산자의 타입을 일치시킨 다음(자동형 변환)에 비교
...
//    즉 , 둘 다 거짓(false) 이어야만 최종적을 거짓(false) 반환
console.log(true || true); // t
...
// num 변수가 NaN이 아니고 그리고 10 이상인지 확인
console.log(!Number.isNaN(num) && num >= 10)

// 6. 삼항연산자
console.log(num > 0 ? '양수' : '양수가 아니다') // t
console.log(num % 2 === 0 ? '짝수' : '홀수') // f
